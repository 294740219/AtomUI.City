...
public sealed class PluginDependencyTests
{
    ...
    [Fact]
    public void DependencyValidatorRejectsUnsatisfiedPluginDependencyVersionRange()
    {
        var sales = PluginDescriptor.FromManifest(
            PluginManifestBuilder.Minimal(
                pluginId: "com.company.sales",
        ...
        Assert.Contains(
            result.Diagnostics,
            diagnostic => diagnostic.Code == PluginDiagnosticIds.PluginDependencyVersionMismatch
