...
| AUC-SECURITY-007 | Contract | SecurityRegistrationTests; AccessTokenCredentialProviderTests | 断言成功、失败、不可用、取消、DI 默认 provider 和 Data 集成前置条件。 | token 缺失、刷新失败、provider 不可用、取消。 | Completed |
