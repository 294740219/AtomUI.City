...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AUC-TESTING-001 | Yes | Yes | TestHostTests | Baseline Exists | Required | 断言 service、diagnostics、dispose、records。 | Required | Ready to Start Product Implementation |
| AUC-TESTING-002 | Yes | Yes | FakeUiDispatcherTests | Baseline Exists | Required | 断言 queue、UI 线程识别、异常、pending count。 | Required | Ready to Start Product Implementation |
| AUC-TESTING-003 | Yes | Yes | SharedTestUtilitiesTests | Baseline Exists | Required | 断言虚拟时间推进、任务顺序、异常记录。 | Required | Ready to Start Product Implementation |
| AUC-TESTING-004 | Yes | Yes | ModuleTestHostTests | Baseline Exists | Required | 断言 module graph、lifecycle、diagnostics。 | Required | Ready to Start Product Implementation |
