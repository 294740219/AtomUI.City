...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AUC-EVENTBUS-001 | 是 | 是 | EventPublicationTests | 已有基线 | 部分通过 | 断言 delivery result、null event、预取消 token、publish options 边界、result immutable/null delivery、error policy、diagnostics。 | 仍需完整产品合同测试 | 产品化进行中 |
